...
export type Stats = { merchants: number; agents: number; sessions: number; completed: number; gmv_paise: number; audit_entries: number; chain_ok: boolean; ledger: { entries: number; distinct_rules: number; inconsistencies: number } };
